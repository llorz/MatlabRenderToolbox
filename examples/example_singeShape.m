...
renderOptions = {'RotationOps',{[-90,0,0],[0,0,20]},...  
    'CameraPos',[-10,10],...
    'FaceAlpha',0.9,...
    'BackgroundColor',[0.5,0.5,0.5]}; % you can change the background color here
